...
class Model(nn.Module):
    def __init__(self):
        ...
        self.rnn = nn.LSTM(2, 10, bidirectional=True)
...
class Trainer:
    def __init__(self, model):
        ...
        self.writer = SummaryWriter(log_dir='runs/edge_list')
...
if __name__ == '__main__':
    ...
    train_non_euler = np.load('data/train_non_eulerian_edge.npy', allow_pickle=True)
    train_euler = np.load('data/train_eulerian_edge.npy', allow_pickle=True)
    ...
    eval_non_euler = np.load('data/eval_non_eulerian_edge.npy', allow_pickle=True)
    eval_euler = np.load('data/eval_eulerian_edge.npy', allow_pickle=True)
